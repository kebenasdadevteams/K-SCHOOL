...
export default function TeacherSettings() {
  ...
  const user = {
    full_name: authUser?.full_name || locationState?.userName || 'Teacher User',
    email: authUser?.email || locationState?.userEmail || 'teacher@church.com',
  };

  const navigateWithState = (path: string, nextView: ViewType = activeView) => {
    navigate(path, {
      state: {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 flex items-center gap-2">
              ...
              Customize your teaching experience and platform preferences.
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
                        We collect minimal data to improve your teaching experience. Your personal information is always kept private and secure.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
                        ...
                        <button
                          onClick={() => navigateWithState('/teacher/profile')}
